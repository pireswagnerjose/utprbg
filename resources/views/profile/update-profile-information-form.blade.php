<x-form-section submit="updateProfileInformation" class="mt-16">
    <x-slot name="title">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->fisrt_name }}" class="rounded-full h-20 w-20 object-cover">
                </div>
