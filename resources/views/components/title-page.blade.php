<div class="title mb-8 w-full flex">
    <svg class="w-6 h-6 text-zinc-800 dark:text-zinc-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
    ...
    <span class="flex-1 ml-3 whitespace-nowrap text-zinc-900 dark:text-zinc-200 text-lg font-bold">
        {{ $slot }}
    </span>
</div>
