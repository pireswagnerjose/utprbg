<x-app-layout>
    ...
    <div class="mb-12">
        <form action="{{ route('scheduled-visit-of-the-day.index') }}" method="any">
            @csrf
            @include('reports.scheduled-visit.includes.fields')
    ...
    <div class="p-8">
        ...
        @include('reports.scheduled-visit.includes.table')
    </div>
