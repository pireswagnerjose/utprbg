...
<body>
  <div style="width: 345px; height: 200px; border: 1px solid #52525b; padding: 8px; border-radius: 8px;">
    <div style="width: 100%;">
      <div style="width: 75%; float: left;">
        <div style="width: 100%; ">
          ...
          <div style="width: 20%; float: left;">
            <span style="width: 100%;">
              <img style="width: 100%; border-radius: 8px;" src='{{ asset("storage/site/policia_penal_logo.png") }}'
          ...
          <div style="width: 80%; text-align: center; float: right;">
            ...
            <span style="font-size: 9px; font-weight: bold; display: block;">SECRETARIA DA CIDADANIA E JUSTIÇA</span>
        ...
        <div style="background-color: #3f3f46; width: 97%;  margin-top: -12px; margin-bottom: 4px; border-radius: 8px;">
    ...
    <div class="margin-bottom: 8px;">
      ...
      <span style="font-size: 10px; margin-top: 5px; display: block;">PARENTESCO: <strong style="font-size: 13px;">{{
          $identification_card->degree_of_kinship->degree_of_kinship }}</strong></span>
      <div style="margin-top: 10px;">
        <span style="font-size: 16px;">CÓD.: <strong style="font-size: 20px; color: #c81e1e;">{{
            $identification_card->id }}
          </strong></span>
        <span style="margin-left: 64px; font-size: 16px;">VALIDADE: <strong style="font-size: 20px; color: #c81e1e;">{{
  ...
  <div
    ...
    <div style="margin-top: 32px; width: 75%; margin-left: auto; margin-right: auto; border-top: 1px solid #52525b;
    ...
    <div
      style="margin-top: 36px; width: 75%; margin-left: auto; margin-right: auto; border-top: 1px solid #52525b; text-align: center; font-size: 10px;">
      DIRETOR DA UTPRBG
    </div>
  </div>
</body>
