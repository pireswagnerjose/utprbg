<table class="w-full text-sm text-left rtl:text-right text-zinc-500 dark:text-zinc-400">
    <thead class="text-xs text-zinc-700 uppercase bg-zinc-50 dark:bg-zinc-700 dark:text-zinc-400">
        <tr>
            ...
            <th scope="col" class="p-2"> Sentença </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr
            ...
            <td class="p-2"> <a class="text-blue-700" href="{{ route('prisoners.show', $prison->prisoner->id ) }}"> {{
                    $prison->prisoner->name }} </a> </td>
            ...
            <td class="p-2"> {{ \Carbon\Carbon::parse($prison->prisoner->date_birth)->format('d/m/Y') }}</td>
            <td class="p-2"> {{ $prison->sentence }} </td>
        </tr>
        @empty
