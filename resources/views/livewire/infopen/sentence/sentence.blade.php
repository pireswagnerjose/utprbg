<div
    ...
    <div class="grid md:grid-cols-1 md:gap-6 mt-16 mb-6">
        <div class="relative z-0 w-[60%] mx-auto group">
            <select id="sentence" wire:model="sentence" wire:change='sentence_fun'
                ...
                <option class="text-zinc-900 dark:text-zinc-600" value="2">Mais de 6 meses até 1 ano (inclusive)
                </option>
                <option class="text-zinc-900 dark:text-zinc-600" value="3">Mais de 1 ano até 2 anos (inclusive)</option>
                <option class="text-zinc-900 dark:text-zinc-600" value="4">Mais de 2 anos até 4 anos (inclusive)
                </option>
                <option class="text-zinc-900 dark:text-zinc-600" value="5">Mais de 4 anos até 8 anos (inclusive)
                </option>
                <option class="text-zinc-900 dark:text-zinc-600" value="6">Mais de 8 anos até 15 anos (inclusive)
                </option>
                <option class="text-zinc-900 dark:text-zinc-600" value="7">Mais de 15 anos até 20 anos (inclusive)
                </option>
                <option class="text-zinc-900 dark:text-zinc-600" value="8">Mais de 20 anos até 30 anos (inclusive)
                </option>
                <option class="text-zinc-900 dark:text-zinc-600" value="9">Mais de 30 anos até 50 anos (inclusive)
                </option>
                <option class="text-zinc-900 dark:text-zinc-600" value="10">Mais de 50 anos até 100 anos (inclusive)
                </option>
    ...
    <div class="
        ...
        @include('livewire.infopen.sentence.includes.table')
