<div>
    <div class="mx-auto pb-12 p-6 sm:px-6 lg:px-8 bg-white dark:bg-zinc-800 overflow-hidden shadow-sm sm:rounded-lg text-zinc-900 dark:text-zinc-100">
        ...
        <div class="flex mb-4">
            <h2 class="font-semibold text-lg text-zinc-800 dark:text-zinc-400 mb-5">Cadastro de País</h2>
        </div>
        ...
        {{-- create --}}
        @if($add_new == true)
            @include('livewire.admin.country.includes.create')
        @endif

        {{-- search --}}
        @include('livewire.admin.country.includes.search')

        {{-- card --}}
        @foreach ($countries as $country)
            @include('livewire.admin.country.includes.card')
        @endforeach
        @include('livewire.admin.country.includes.modal-update')
        @include('livewire.admin.country.includes.modal-delete')
