<div>
    <div class="mx-auto pb-12 p-6 sm:px-6 lg:px-8 bg-white dark:bg-zinc-800 overflow-hidden shadow-sm sm:rounded-lg text-zinc-900 dark:text-zinc-100">
        ...
        <div class="flex mb-4">
            <h2 class="font-semibold text-lg text-zinc-800 dark:text-zinc-400 mb-5">Comarca</h2>
        </div>
        ...
        {{-- create --}}
        @if($add_new == true)
            @include('livewire.admin.legal-assistance.district.includes.create')
        @endif

        {{-- search --}}
        @include('livewire.admin.legal-assistance.district.includes.search')

        {{-- card --}}
        @foreach ($districts as $district)
            @include('livewire.admin.legal-assistance.district.includes.card')
        @endforeach
        @include('livewire.admin.legal-assistance.district.includes.modal-update')
        @include('livewire.admin.legal-assistance.district.includes.modal-delete')
