<div>
    <div
        ...
        <ul class="flex flex-wrap h-12 justify-center items-center text-xs font-semibold text-center border-b border-zinc-200 dark:border-zinc-700"
            id="myTab" data-tabs-toggle="#myTabContent" role="tablist">

            @can('show_prisons')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button class="inline-block h-full uppercase px-2 py-2 border-b" id="prisoes-tab"
                        data-tabs-target="#prisoes" type="button" role="tab" aria-controls="prisoes"
                        aria-selected="false">
            ...
            @can('show_processes')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button
                        ...
                        id="processos-tab" data-tabs-target="#processos" type="button" role="tab"
                        aria-controls="processos" aria-selected="false">
                        Processos</button>
                </li>
            @endcan
            ...
            @can('show_photos')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button
                        class="inline-block h-full uppercase px-2 py-2 border-b border-transparent hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300"
                        id="fotos-tab" data-tabs-target="#fotos" type="button" role="tab" aria-controls="fotos"
                        aria-selected="false">
                        Fotos</button>
                </li>
            @endcan
            ...
            @can('show_addresses')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button
                        class="inline-block h-full uppercase px-2 py-2 border-b border-transparent hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300"
                        id="enderecos-tab" data-tabs-target="#enderecos" type="button" role="tab"
                        aria-controls="enderecos" aria-selected="false">
                        Endereços</button>
                </li>
            @endcan
            ...
            @can('show_internal_services')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button
                        class="inline-block h-full uppercase px-2 py-2 border-b border-transparent hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300"
                        id="atendimentos_internos-tab" data-tabs-target="#atendimentos_internos" type="button"
                        role="tab" aria-controls="atendimentos_internos" aria-selected="false">
            ...
            @can('show_legal_assistances')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button
                        class="inline-block h-full uppercase px-2 py-2 border-b border-transparent hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300"
                        id="atendimentos_juridicos-tab" data-tabs-target="#atendimentos_juridicos" type="button"
                        role="tab" aria-controls="atendimentos_juridicos" aria-selected="false">
            ...
            @can('show_families')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button
                        class="inline-block h-full uppercase px-2 py-2 border-b border-transparent hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300"
                        id="families-tab" data-tabs-target="#families" type="button" role="tab"
                        aria-controls="families" aria-selected="false">
                        Familiares</button>
                </li>
            @endcan
            ...
            @can('show_pads')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button
                        class="inline-block h-full uppercase px-2 py-2 border-b border-transparent hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300"
                        id="pads-tab" data-tabs-target="#pads" type="button" role="tab" aria-controls="pads"
                        aria-selected="false">
                        PADS</button>
                </li>
            @endcan
            ...
            @can('show_visits')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button
                        class="inline-block h-full uppercase px-2 py-2 border-b border-transparent hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300"
                        id="visitas-tab" data-tabs-target="#visitas" type="button" role="tab"
                        aria-controls="visitas" aria-selected="false">
                        Visitas</button>
                </li>
            @endcan

            @can('show_unit_address')
                <li class="mr-1 mb-1 h-full rounded-t-lg bg-zinc-200 dark:bg-zinc-700" role="presentation">
                    <button
                        class="inline-block h-full uppercase px-2 py-2 border-b border-transparent hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300"
                        id="unit_address-tab" data-tabs-target="#unit_address" type="button" role="tab"
                        aria-controls="unit_address" aria-selected="false">
                        Mudanças de Cela</button>
                </li>
            @endcan
        </ul>
        ...
        <div id="myTabContent">
            ...
            <div class="hidden py-4" id="atendimentos_internos" role="tabpanel"
                aria-labelledby="atendimentos_internos-tab">
                <livewire:main.internal-service.internal-service-livewire :$prisoner_id />
            </div>

            <div class="hidden py-4" id="atendimentos_juridicos" role="tabpanel"
                aria-labelledby="atendimentos_juridicos-tab">
                            ...
                            <a href="{{ route('visitant.show', ['visitant_id' => $identification_card->visitant_id]) }}"
                                ...
                                <div class="flex gap-2 items-center font-semibold text-blue-700 dark:text-blue-500">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-xs">Contato:
                                            {{ $identification_card->visitant->phone }}</span>
                                    </div>
                                </div>
                            </a>
                        @endforeach
            ...
            <div class="hidden py-4" id="unit_address" role="tabpanel" aria-labelledby="unit_address-tab">
                <div class="flex items-center border-b border-blue-400 dark:border-blue-600 mb-4 w-full">
                    <h1 class="text-blue-600 dark:text-blue-700 text-center uppercase w-full">Histórico de mudanças de
                        cela
                    </h1>
                </div>
                <div>
                    @if (!empty($prisoner_show->unit_address))
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-4">
                            @foreach ($prisoner_show->unit_address as $unit_address)
                                <div class="border-b border-zinc-300 dark:border-zinc-600 w-full">
                                    <p class="text-center"><span
                                            class="text-[9pt] uppercase text-zinc-400 dark:text-zinc-500">ALA /
                                            CELA:</span>
                                        {{ $unit_address->cell->cell }}</p>
                                    <p class="text-center"><span
                                            class="text-[9pt] uppercase text-zinc-400 dark:text-zinc-500">DATA DO
                                            REGISTRO:</span>
                                        {{ \Carbon\Carbon::parse($unit_address->created_at)->format('d/m/Y') }}</p>
                                </div>
                            @endforeach
                        </div>
                    @endif
