  ...
  <div class="flex justify-end gap-2 my-2">
    ...
    <div class="group grid justify-items-center w-12 border-b border-zinc-200 dark:border-zinc-600">
      <button type="button" wire:confirm="Tem certeza que deseja excluir o Preso"
        wire:click="delete({{ $prisoner_show->id }})" class="w-6 h-6 bg-red-600 dark:bg-red-500 rounded-full p-1">
        <svg class="w-4 h-4 text-red-50 dark:text-red-50 hover:text-red-400 hover:dark:text-red-400" aria-hidden="true"
