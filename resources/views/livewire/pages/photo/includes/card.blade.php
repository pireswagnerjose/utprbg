            ...
            <div class="text-center">
                ...
                @can('admin-cartorio_admin')
                    <div class="flex space-x-2 mb-2">
                        {{-- Editar --}}
                        <button wire:click="modal({{ $photo->id }})" class="w-5 h-5 p-1 bg-blue-600 dark:bg-blue-500 rounded-full shadow-lg">
                            <svg class=" w-3 h-3 text-blue-50 dark:text-blue-50 hover:text-blue-400 hover:dark:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
                        ...
                        <button type="button" wire:confirm="Tem certeza que deseja excluir a Foto" wire:click="delete({{ $photo->id }})"
                            ...
                            <svg class="w-3 h-3 text-red-50 dark:text-red-50 hover:text-red-400 hover:dark:text-red-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
