                ...
                <div
                    ...
                    <div class="absolute z-10 w-auto mt-1 text-sm bg-white border border-zinc-100 rounded-lg shadow-md dark:border-zinc-700 md:grid-cols-3 dark:bg-zinc-700">
                        <div
                            ...
                            {{-- Tipos Penais --}}
                            <a href="{{ route('infopen.type-prisons') }}" class="flex items-center text-zinc-500 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-500 group">
                            ...
                            {{-- Escolaridade --}}
                            <a href="{{ route('infopen-prisoner') }}" class="flex items-center text-zinc-500 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-500 group">
