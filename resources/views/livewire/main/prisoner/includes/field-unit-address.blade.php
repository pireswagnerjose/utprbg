...
<div class="grid md:grid-cols-4 md:gap-6 mb-8 mt-12">
    ...
    <div class="col-span-2 relative z-0 w-full group">
        <select id="ward_id" required wire:model="ward_id" wire:change='cell' class="block py-1 mt-1 px-0 w-full text-sm text-zinc-500 dark:text-zinc-400 bg-transparent border-0 border-b border-zinc-400 dark:border-zinc-600 dark:focus:border-blue-500 focus:border-blue-600 appearance-none focus:outline-none focus:ring-0 peer">
