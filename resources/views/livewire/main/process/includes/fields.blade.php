...
<div class="grid md:grid-cols-3 mb-8 md:gap-6">
    ...
    <div class="col-span-1 relative z-0 w-full group">
        <x-input type="text" wire:model="eproc" id="eproc"  x-mask="9999999-99.9999.999.9999" maxlength="24" />
...
<div class="grid md:grid-cols-3 mb-8 md:gap-6">
    <div class="col-span-1 relative z-0 w-full group">
        <x-input type="text" wire:model="seeu" id="seeu" x-mask="9999999-99.9999.9.99.9999" maxlength="25" />
        <x-label for="seeu" wire:model="seeu" value="{{ 'SEEU' }}" />
        <x-input-error for="seeu" class="mt-2">{{ $message ?? '' }}</x-input-error>
    </div>
    <div class="col-span-1 relative z-0 w-full group">
        <x-input type="text" wire:model="pje" id="pje" x-mask="9999999-99.9999.999.9999" maxlength="24" />
        <x-label for="pje" wire:model="pje" value="{{ 'PJE' }}" />
        <x-input-error for="pje" class="mt-2">{{ $message ?? '' }}</x-input-error>
    </div>
    <div class="col-span-1 relative z-0 w-full group">
        <x-input type="text" wire:model="apf" id="apf" x-mask="9999999-99.9999.9.99.9999" maxlength="25" />
