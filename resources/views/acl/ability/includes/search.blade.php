<form action="{{ route('ability.index' ) }}" method="get">
    @csrf
    <div class="flex items-center gap-2 justify-center px-2 pb-3 my-4 border-b border-blue-300 dark:border-blue-500 ">
        <div
            ...
            <x-lucide-search class="w-7 h-7 text-zinc-100 dark:text-zinc-200"></x-lucide-search>
        ...
        <button type="submit"
            ...
            <x-lucide-search class="p-1 w-7 h-7 text-zinc-100 dark:text-zinc-200"></x-lucide-search>
        </button>
    </div>
</form>